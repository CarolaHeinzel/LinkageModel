...
def  compute_likelihood_single_chromosome_diploid(X1, X2, q, p, d, r):
    
    l1 =  compute_likelihood_single_chromosome(X1, q, p, d, r)
    l2 =  compute_likelihood_single_chromosome(X2, q, p, d, r)
    return l1*l2

def grid_search(X1, X2, p,  r_range, K, d_t):
    """
    ...
    for x in q_range:
        ...
        for r in r_range:
            ...
            current_log_likelihood = compute_likelihood_single_chromosome_diploid(X1, X2, [q_1,1-q_1], p, d_t, r)
